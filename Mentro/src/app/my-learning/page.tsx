      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14 space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <motion.div 
            ...
            className="lg:col-span-4 rounded-[2rem] bg-white dark:bg-white/[0.04] border border-gray-200 dark:border-white/[0.08] shadow-sm p-8 flex flex-col justify-between relative overflow-hidden group backdrop-blur-sm"
          >
          ...
          <motion.div 
            ...
            className="lg:col-span-8 rounded-[2rem] bg-gray-100 dark:bg-slate-950 border border-gray-200 dark:border-white/[0.08] overflow-hidden relative shadow-sm dark:shadow-none"
          >
            <Image 
              ...
              className="object-cover opacity-30 dark:opacity-40 mix-blend-multiply dark:mix-blend-overlay transition-transform duration-700"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-gray-100 via-gray-100/90 to-transparent dark:from-slate-950 dark:via-slate-950/90 dark:to-transparent" />
            
            <div className="relative h-full p-8 lg:p-10 flex flex-col justify-center max-w-2xl text-gray-900 dark:text-white bg-gradient-to-r from-gray-100/80 via-gray-100/60 to-transparent dark:from-slate-950/90 dark:via-slate-950/70 dark:to-transparent">
              <div className="flex items-center gap-3 mb-6">
                <span className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400 text-xs font-bold rounded-full border border-emerald-200 dark:border-emerald-500/30">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 dark:bg-emerald-400 animate-pulse" />
                  UP NEXT
                </span>
                <span className="text-sm text-gray-600 dark:text-white/70 font-medium bg-gray-200/80 dark:bg-black/40 px-3 py-1 rounded-full backdrop-blur-md">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-white leading-[1.1] tracking-tight mb-6 line-clamp-2">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-auto">
                ...
                <Link
                  ...
                  className="px-6 py-3.5 bg-gray-200/80 hover:bg-gray-300/80 dark:bg-white/10 dark:hover:bg-white/15 border border-gray-300 dark:border-white/20 text-gray-800 dark:text-white text-sm font-semibold rounded-xl transition-all backdrop-blur-md"
                >
                  View Agenda
                </Link>

                <div className="ml-auto hidden sm:flex items-center gap-3 bg-gray-200/60 dark:bg-black/30 p-2 pr-4 rounded-full backdrop-blur-md border border-gray-300 dark:border-white/10">
                   <div className="relative w-8 h-8 rounded-full overflow-hidden ring-2 ring-brand/50">
                     <Image src={nextMentor.avatar || "/images/mentor-sarah-chen.jpg"} alt={nextMentor.name} fill sizes="32px" className="object-cover" />
                   </div>
                   <div className="text-xs">
                     <p className="font-bold text-gray-900 dark:text-white leading-tight">{nextMentor.name}</p>
                     <p className="text-gray-500 dark:text-white/60">{nextMentor.company}</p>
                   </div>
                </div>
              </div>
            </div>
